var AudioSupervisor = (this.AudioSupervisor = function () {
    var n,
      e = this;
    return (
      (e.init = function (e) {
  ...
  KeySupervisor = (this.KeySupervisor = function () {
    var t,
      o,
      i,
      r,
  ...
  LiveSetExporter = (this.LiveSetExporter = function () {
    var i;
    return (
      (this.init = function () {
        i = [];
  ...
  Metronome = (this.Metronome = function () {
    var o, t;
    return (
      (this.init = function (e) {
  ...
  Recorder = (this.Recorder = function () {
    var t;
    return (
      (this.init = function (e) {}),
  ...
  SampleCache = (this.SampleCache = function () {
    var i,
      n = this;
    return (
      (n.init = function () {
  ...
  SingleTouchObserver = (this.SingleTouchObserver = function () {
    var r;
    return (
      (this.init = function (e) {
        (r = e),
...
var GLOBAL_PITCHPAD_SYNTH,
  ...
  PitchpadSynth = (this.PitchpadSynth = function () {
    var i,
      r,
      a,
      s,
  ...
  ScaleExplorer = (this.ScaleExplorer = function () {
  ...
  SimpleDrumpad = (this.SimpleDrumpad = function () {
    var n, t, o, i, r, a, s, l;
    return (
      (this.init = function (e) {
        if (!BrowserCompatibility.isBrowserCompatible())
  ...
  PIANOROLL_VERSION = 2,
  PianoRollEditor = (this.PianoRollEditor = function () {
    var o,
      i,
      r,
      a,
...
var PianoRollExport = {
  ...
  PianoRollPlayer = (this.PianoRollPlayer = function () {
    var o,
      l,
      d,
      t,
...
var SimplePianoRoll = (this.SimplePianoRoll = function () {
  var t,
    i,
    r,
    n,
...
var SimpleSession = (this.SimpleSession = function () {
    var o, n, i, r, a, s, l, d;
    return (
      (this.init = function (e) {
        if (!BrowserCompatibility.isBrowserCompatible())
  ...
  SongFormExplorer = (this.SongFormExplorer = function () {
    var i, r, a;
    return (
      (this.init = function (e) {
        (a = e),
...
var YouTube = (this.YouTube = function () {
  var n,
    t,
    o,
    i,
